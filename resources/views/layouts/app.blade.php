...
<head>
    ...
    <style>
        /* Gaya dasar untuk tema gelap konsisten URBAN VIBE */
        body {
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center gap-4">
                    @auth
                        ...
                        <a href="{{ route('cart') }}" class="text-white text-decoration-none position-relative {{ request()->routeIs('cart') ? 'text-primary' : '' }}">
