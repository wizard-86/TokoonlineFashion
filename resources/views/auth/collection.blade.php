...
@section('content')
    ...
    <!-- 2. EXTENDED COLLECTION SECTION (Grid 4 Menyamping) -->
    <section id="collection" class="py-5" style="background-color: #0b0b0b;">
        <div class="container py-4">
            ...
            <!-- BARIS 1: Produk Asli dari image_d9dd62.jpg -->
            ...
            <!-- BARIS 2: Tambahan Produk Baru (4 Gambar Menyamping) -->
            <div class="row g-4 mb-5">
                <!-- Product 5 -->
            ...
            <!-- BARIS 3: Tambahan Produk Baru (4 Gambar Menyamping) -->
            <div class="row g-4">
                <!-- Product 9 -->
                <div class="col-md-6 col-lg-3 product-card-wrapper" data-category="t-shirt">
                    <div class="product-card">
